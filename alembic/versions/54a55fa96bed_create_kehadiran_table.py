...
def upgrade():
    op.create_table(
        ...
        sa.Column("id_dosen", sa.BigInteger(), nullable=False),
        sa.Column("id_mata_kuliah", sa.BigInteger(), nullable=False),
...
def downgrade():
    op.drop_index("ix_kehadiran_id_mata_kuliah", table_name="kehadiran")
